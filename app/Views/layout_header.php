...
<body class="bg-white">
    <header>
        <nav class="navbar navbar-expand-lg bg-light py-2 fixed-top">
            <div class="container">
                <!-- Logo -->
                <a class="navbar-brand fw-bold" href="index.php">THC <span class="text-primary">Furniture</span></a>
                <!-- Toggle Btn -->
                            ...
                            <div class="dropdown">
                                ...
                                <?php if (!isset($_SESSION['user'])): ?>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><a class="dropdown-item" href=" user/signup">Đăng ký</a></li>
                                    </ul>
                                <?php else: ?>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href=" user/info">Tài khoản</a></li>
                                        <li><a class="dropdown-item" href=" user/login">Quản lý đơn hàng</a></li>
                                        <li class="border-top mt-2 py-1 opacity-75"><a class="dropdown-item" href=" user/logout">Đăng xuất</a></li>
                                    </ul>
                                <?php endif; ?>
                                <!-- <ul class="dropdown-menu dropdown-menu-end">
